...
# estimates of k for SARS-CoV-2 from Riou and Althaus (2020) Euro Surveill
k_vec <- c(0.54, 0.14, 6.95) # median and 90 % highest density interval
r0_vec <- seq(0.1, 5, by = 0.1)
...
```{r plot_pext_and_finalsize, out.width = "50%", fig.show = 'hold'}
...
#subtitle = "Values of dispersion (k) based on estimated posterior median and 90 % HDI for SARS-CoV-2*",
#caption = "*Riou and Althaus (2020) Euro Surveill",
x = "Basic reproductive number (R0)",
y = "Probability of extinction (q)",
col = "dispersion (k)")

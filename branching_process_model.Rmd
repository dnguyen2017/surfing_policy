...
delay_reset %>% pull(delay) %>% ecdf() %>% 
  plot(xlim = c(1, 10), ylim = c(0, 1), 
       main = "Distribution of detection delay for RSPRT", ylab = "proportion of simulations", xlab = "detection lag")
...
delay_wt %>% pull(delay) %>% ecdf() %>% 
  plot(xlim = c(1, 10), ylim = c(0, 1), 
       main = "Distribution of detection delay for WSPRT", ylab = "proportion of simulations", xlab = "detection lag")
...
```{r comparison_line_plots, out.width="50%", fig.show="hold"}
# test_sprt %>%
#   ggplot() +
#   geom_line(aes(x = time, y = infected, group = simulation)) +
...
```{r comparison_bar_plots,out.width="50%", fig.show="hold"}
# test_sprt %>%
#   group_by(time) %>%
#   count(decision) %>%
